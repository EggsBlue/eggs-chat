package cn.eggschat.common.shiro;
...
public class AdminAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        Sys_user user = userService.fetch(Cnd.where("email", "=", loginname));
        ...
        session.setAttribute("uname", user.getFull_name());
        session.setAttribute("unitId", user.getUnit_id());
